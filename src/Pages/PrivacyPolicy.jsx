          ...
          <main className="lg:w-3/4 bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100 space-y-16 leading-relaxed text-gray-600">
            ...
            <section id="collection" className="space-y-6 scroll-mt-32">
              <div className="flex items-center gap-4 text-gray-900">
                ...
                <h2 className="text-2xl md:text-3xl font-bold font-[Judson]">PERSONAL INFORMATION WE COLLECT</h2>
              </div>
            ...
            <section id="cookies" className="space-y-6 scroll-mt-32">
              <div className="flex items-center gap-4 text-gray-900">
                ...
                <h2 className="text-2xl md:text-3xl font-bold font-[Judson]">COOKIES & OTHER TRACKING TECHNOLOGIES</h2>
              </div>
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={i} className="p-6 bg-[#FDFCFB] rounded-2xl border border-gray-100 hover:border-[#1F352F]/20 transition-colors">
            ...
            <section id="usage" className="space-y-6 scroll-mt-32">
              <div className="flex items-center gap-4 text-gray-900">
                ...
                <h2 className="text-2xl md:text-3xl font-bold font-[Judson]">HOW DO WE USE YOUR PERSONAL INFORMATION?</h2>
              </div>
              <div className="space-y-4 bg-gray-50 p-8 rounded-3xl border border-dashed border-gray-200">
            ...
            <section id="sharing" className="space-y-6 scroll-mt-32">
              <div className="flex items-center gap-4 text-gray-900">
                ...
                <h2 className="text-2xl md:text-3xl font-bold font-[Judson]">SHARING YOUR PERSONAL INFORMATION</h2>
              </div>
              <p>
            ...
            <section id="optout" className="space-y-6 scroll-mt-32">
              <div className="flex items-center gap-4 text-gray-900">
                ...
                <h2 className="text-2xl md:text-3xl font-bold font-[Judson]">OUR OPT-OUT POLICY</h2>
              </div>
            ...
            <section id="rights" className="space-y-6 scroll-mt-32">
              <div className="flex items-center gap-4 text-gray-900">
                ...
                <h2 className="text-2xl md:text-3xl font-bold font-[Judson]">YOUR DATA RIGHTS</h2>
              </div>
              <p>
            ...
            <section id="contact" className="space-y-6 scroll-mt-32">
              <div className="flex items-center gap-4 text-gray-900">
                ...
                <h2 className="text-2xl md:text-3xl font-bold font-[Judson]">CONTACT US</h2>
              </div>
              <div className="bg-[#1F352F] text-white p-8 rounded-3xl text-center">
                <p className="mb-6 opacity-90">Questions about our privacy practices? Our team is here to help.</p>
                <a href="mailto:support@glamgait.com" className="inline-block px-8 py-4 bg-white text-[#1F352F] rounded-full font-bold hover:scale-105 transition-transform shadow-xl">
