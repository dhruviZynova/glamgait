        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <main className="lg:w-3/4 bg-white rounded-3xl p-4 md:p-12 shadow-sm border border-gray-100 space-y-16 leading-relaxed text-gray-600">
            ...
            <section id="charges" className="space-y-6 scroll-mt-32">
              ...
              <div className="bg-[#1F352F]/5 p-4 md:p-8 rounded-3xl border border-[#1F352F]/10">
            ...
            <section id="timeline" className="space-y-6 scroll-mt-32">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={i} className="p-4 md:p-6 bg-gray-50 rounded-2xl border border-gray-100 text-center">
            ...
            <section id="contact" className="space-y-6 scroll-mt-32">
              ...
              <div className="bg-[#1F352F] text-white p-4 py-8 md:p-8 rounded-3xl text-center shadow-xl">
                <p className="mb-6 opacity-90 text-sm md:text-base">Have questions about your delivery status?</p>
