...
const SideBar = ({ onMenuChange = () => { } }) => {
  ...
  return (
    <>
      {/* Mobile Header */}
      <div className="md:hidden px-4 py-4 flex justify-between items-center bg-white border-b border-gray-100 sticky top-0 z-20">
        <h1 className="text-lg font-semibold text-gray-900">My Account</h1>
        <button onClick={() => setIsOpen(!isOpen)} className="p-1 rounded-lg hover:bg-gray-50 transition-colors">
      ...
      {showLogoutModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-[#00000060] backdrop-blur-sm z-50 transition-all duration-300">
