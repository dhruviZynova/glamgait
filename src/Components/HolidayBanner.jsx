        ...
        <section className="px-4 py-6 md:py-16 md:px-8 lg:px-10">
            <div className="bg-[#1C2F2F] rounded-3xl overflow-hidden flex flex-col md:flex-row items-center md:h-[400px] lg:h-[430px]">
                ...
                <div className="flex-1 p-6 md:p-10 py-16 lg:p-12 text-white space-y-4">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-[Playfair Display] font-bold font-700">
                        Save 50% this Holiday season
                    </h2>
                    <p className="text-sm md:text-base lg:text-lg font-[Montserrat] font-500 opacity-90 max-w-xl">
                    ...
                    <div className="pt-2">
                        <button className="px-6 py-2 border-2 border-white rounded-full text-white font-[Montserrat] font-500 text-sm md:text-base hover:bg-white hover:text-[#1A2C2B] transition-colors duration-300">
                            Shop Now
                        </button>
                    </div>
                </div>
